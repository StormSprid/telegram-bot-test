...
_GREETING  = {"/start","start","привет","здравствуй","здравствуйте","добрый день","доброе утро","добрый вечер","сәлем","салам","hello","hi","салем","қайырлы күн","қайырлы таң","қайырлы кеш","сал"}
...
_CONTACTS  = ("адрес","где находится","контакт","телефон","номер","email","почта","где магазин","где офис","шоурум","ваш магазин","как доехать","как добраться","как найти","мекенжай","қайда орналасқан","дүкен қайда")
_DELIVERY  = ("доставк","самовывоз","курьер","привезти","привезут","жеткізу","тасымал","өзім алып кету")
_PAYMENT   = ("оплат","платеж","карта","kaspi","visa","mastercard","төлем","қалай төлеу")
_RETURNS   = ("возврат","вернуть","обмен","претензия")
_TINTING   = ("колеровк","оттенок","подбор цвет","45000","45 000","ral","ncs","түс таңдау","реңк")
_BRANDS    = ("бренд","бренды","марк","производител","dulux","hammerite","pinotex","levis","sikkens","dufa","teknos","hygge","oikos","little greene","swiss lake","kelly-moore","master color","брендтер","өндіруші")
_PRODUCTS  = ("товар","ассортимент","краск","лак","грунтовк","шпатлевк","штукатурк","антисептик","малярн","лкм","что продает","что есть","что предлагает","бояу","бояулар","материалдар")
_SERVICES  = ("услуг","чем можете помочь","что вы делает","предоставляет","қызметтер","не ұсынасыз")
_DESIGNERS = ("дизайнер",)
_BUILDERS  = ("строител","подрядчик","бригада")
_CLIENTS   = ("клиент","партнер","покупател","заказчик")
_OVERVIEW  = ("о компании","чем занимается","что такое центр красок","расскажи о вас","кто вы","компания туралы","сіздер кімсіздер")
...
_COMPARISON = (
    ...
    "қандай айырмашылық", "қайсысы жақсы", "не таңдау керек",
    "қалай қолдану", "кеңес беріңіз", "қандай бояу",
)
_COMPANY   = ("краск","центр красок","centr krasok","магазин","товар","бренд","лак","цвет","ремонт","стен","покраск","бояу","дүкен","жеткізу","төлем","материал")
